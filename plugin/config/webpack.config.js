  ...
  return {
    ...
    resolve: {
      ...
      plugins: [
        ...
        //   resourceRegExp: /^electron$/, // 忽略 electron 模块
        // }),
      ],
    ...
    plugins: [
        new CopyPlugin({
          patterns: [
            {
              from: path.resolve(__dirname, '../src/lib/som.js'),
              to: path.resolve(__dirname, '../openwebagent-extension/static/js/som.js'),  
            },
          ],
        }),
