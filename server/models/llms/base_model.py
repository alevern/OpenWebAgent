...
class BaseModel:
    ...
    def get_planner_prompt(
        self, instruction: str, index: int, html_text: str, contents: List[Turn]
    ) -> List[Dict]:
        print_with_color(f"Instruction: {instruction}", "green")
        messages = [
            {
                "role": "system",
                "content": [{"type": "text", "text": self.planner_prompt}],
            }
        ]
        for content in contents:
            ...
            message = [
                {
                    "role": "user",
                    "content": [{"type": "text", "text": self.past_rnd_prompt}],
                },
                {
                    "role": "assistant",
                    "content": [{"type": "text", "text": content["response"]}],
                },
            ]
        ...
        messages.append(
            {
                ...
                "content": [
                    ...
                    # {
                    #     "type": "image_url",
                    #     "image_url": {"url": content.screenshot},
                    # },
                ],
            }
        )
